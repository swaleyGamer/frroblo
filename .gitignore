...
Frame.BackgroundColor3 = Color3.fromRGB(44, 44, 44) -- Fond gris foncé
Frame.BorderColor3 = Color3.new(0, 0, 0)
Frame.BorderSizePixel = 0 -- Suppression de la bordure
Frame.Parent = ScreenGui

-- Ajout du texte en haut à gauche
local TopText = Instance.new("TextLabel")
TopText.Text = "FRONTLINES BY SWALEY"
TopText.Font = Enum.Font.SourceSansBold
TopText.TextSize = 20
TopText.TextColor3 = Color3.new(1, 1, 1) -- Texte blanc
TopText.Position = UDim2.new(0, 10, 0, 10)
TopText.Size = UDim2.new(0, 200, 0, 30)
TopText.Parent = Frame

-- Ajout du texte en bas à droite
local BottomText = Instance.new("TextLabel")
BottomText.Text = "swaleyrt#2515"
BottomText.Font = Enum.Font.SourceSansBold
BottomText.TextSize = 14
BottomText.TextColor3 = Color3.new(1, 1, 1) -- Texte blanc
BottomText.Position = UDim2.new(1, -120, 1, -30)
BottomText.Size = UDim2.new(0, 120, 0, 20)
BottomText.TextXAlignment = Enum.TextXAlignment.Right -- Alignement à droite
BottomText.Parent = Frame

-- Ajout du bouton "Inject"
local InjectButton = Instance.new("TextButton")
InjectButton.Text = "Inject"
InjectButton.Font = Enum.Font.SourceSansBold
InjectButton.TextSize = 18
InjectButton.Size = UDim2.new(0, 100, 0, 40)
InjectButton.Position = UDim2.new(0.5, -50, 0.5, -20)
InjectButton.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
InjectButton.TextColor3 = Color3.new(1, 1, 1)
InjectButton.Parent = Frame

-- Fonction pour fermer la fenêtre
local function closeWindow(inputObject)
    if inputObject.UserInputType == Enum.UserInputType.MouseButton1 and inputObject.Target == InjectButton then
        ScreenGui:Destroy()
...
game:GetService("UserInputService").InputBegan:Connect(closeWindow)


local HitboxSize = Vector3.new(5,5,5) --CREATE BY swaleyrt#2515
